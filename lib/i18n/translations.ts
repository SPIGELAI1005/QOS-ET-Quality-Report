...
const translations: Record<LanguageKey, Translations> = {
  en: {
    common: {
      ...
      defective: "Defective",
      average: "Average",
      periodMode12mb: "Rolling 12 Months (R12M)",
    ...
    dashboard: {
      ...
      showing12MonthLookback: "Showing rolling 12 months (R12M) from",
    ...
    glossary: {
      ...
      termsList: {
        ...
        metrics: {
          ...
          lookbackWindow: { term: "Rolling 12 Months (R12M) window", definition: "A rolling 12-month window ending at the selected month/year used for consistent trend visuals." },
        },
        chartsViews: {
      ...
      faqs: {
        ...
        ytdLookback: {
          ...
          a: "The selector uses a Rolling 12 Months (R12M) window ending at the selected month/year to provide a consistent trend window across pages. The page title keeps \"YTD //\" for consistency with the dashboard naming.",
        },
        plantFiltering: {
  ...
  de: {
    common: {
      ...
      periodMode12mb: "Rollierende 12 Monate (R12M)",
    ...
    dashboard: {
      ...
      showing12MonthLookback: "Zeige rollierende 12 Monate (R12M) ab",
    ...
    glossary: {
      ...
      termsList: {
        ...
        metrics: {
          ...
          lookbackWindow: { term: "Rollierende 12 Monate (R12M) Fenster", definition: "Ein rollierendes 12-Monats-Fenster, das am ausgewählten Monat/Jahr endet und für konsistente Trendvisualisierungen verwendet wird." },
        },
        chartsViews: {
      ...
      faqs: {
        ...
        ytdLookback: {
          ...
          a: "Der Selektor verwendet ein Fenster aus rollierenden 12 Monaten (R12M), das am ausgewählten Monat/Jahr endet, um ein konsistentes Trendfenster über alle Seiten hinweg zu bieten. Der Seitentitel behält \"JTD //\" für Konsistenz mit der Dashboard-Benennung bei.",
        },
        plantFiltering: {
  ...
  it: {
    ...
    common: {
      ...
      defective: "Difettoso",
      average: "Media",
      periodMode12mb: "12 mesi mobili (R12M)",
    ...
    dashboard: {
      ...
      showing12MonthLookback: "Mostra 12 mesi mobili (R12M) da",
    ...
    glossary: {
      ...
      termsList: {
        ...
        metrics: {
          ...
          lookbackWindow: { term: "Finestra 12 mesi mobili (R12M)", definition: "Una finestra mobile di 12 mesi che termina al mese/anno selezionato usata per visualizzazioni trend coerenti." },
        },
        chartsViews: {
      ...
      faqs: {
        ...
        ytdLookback: {
          ...
          a: "Il selettore usa una finestra 12 mesi mobili (R12M) che termina al mese/anno selezionato per fornire una finestra di tendenza coerente tra le pagine. Il titolo della pagina mantiene \"YTD //\" per coerenza con la denominazione della dashboard.",
        },
        plantFiltering: {
